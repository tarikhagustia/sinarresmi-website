...
return [
    ...
    "Events Description"=>"The cultural principles that are still preserved from the ancestors, make the Cultural Activities carried out by Kasepuhan Sinar Resmi a special attraction. These activities have been carried out from generation to generation from the first traditional leader, and are maintained until now.",
    
    // News
    "Kasepuhan News"=>"Kasepuhan News",
    "News Description"=>"With many visitors who come to Kasepuhan Sinar Resmi from various circles, this portal also provides the latest information related to Kasepuhan Sinar Resmi published in the mass media.",
