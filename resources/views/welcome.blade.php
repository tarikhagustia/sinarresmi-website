        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
                <div class="col-md-7 ftco-animate fadeInUp ftco-animated hero">
                    ...
                    <p class="caps">A landscape is the result of the succession, over time, of the
                        environmental, social, cultural, and economicproductive evolutionary processes that occur in an
                        area</p>
                </div>
    ...
    <div class="container">
                ...
                <div class="row no-gutters">
                    <div class="col-md d-flex">
                        <div class="form-group p-4 border-1">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <input name="name" type="text" class="form-control form-control-sm form-booking"
                                    placeholder="Your team or Individual name">
                            </div>
                        </div>
                    </div>
                    <div class="col-md d-flex">
                        <div class="form-group p-4">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <input name="date_in" type="date" class="form-control form-control-sm form-booking"
                    ...
                    <div class="col-md d-flex">
                        <div class="form-group p-4">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="icon mr-3"><span class="far fa-calendar"></span></div>
                                <input name="date_out" type="date" class="form-control form-control-sm form-booking"
                                    placeholder="Visit Date">
                            </div>
                        </div>
                    </div>
                    <div class="col-md d-flex">
                        <div class="form-group p-4">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="icon mr-3"><span class="far fa-user"></span></div>
                                <input name="visitor" type="text" class="form-control form-control-sm form-booking"
                    ...
                    <div class="col-md d-flex p-4">
                        <div class="form-group d-flex w-100 border-0">
                            <div class="form-field w-100 align-items-center d-flex">
                                <button type="submit" class="form-control rounded-0 btn btn-success btn-booking">Booking
                                    Now</button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p class="text-muted">
                    Kasepuhan Sinar Official led by Abah Asep Nugraha is located in Cisolok District, and is a diversity
                    of one of the traditional villages of Kasepuhan Banten Kidul which is still preserved. Kasepuhan
                    Sinar Official is an integral part of the cultural aspect of the Ciletuh Geopark.
                </p>
                <p class="text-muted">
                    The Kasepuhan Sinar Official community still carries out the traditions of their ancestors in the
                    agricultural sector. In this traditional village, from the process of planting rice to harvesting it
                    is always accompanied by ceremonies related to agriculture. The most famous ceremony is the Seren
                    Taun which is held to celebrate the rice harvest—and is usually crowded with tourists.
                </p>
