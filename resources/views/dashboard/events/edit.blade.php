        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form action="{{ route('dashboard.events.update', $event) }}" method="POST" enctype="multipart/form-data">
                ...
                <label class="block mb-4 text-sm">
                    ...
                    <input name="status" type="text" value="{{ $event->status }}"
                        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
                        placeholder="Status" />
                    <span class="text-xs text-gray-600 dark:text-gray-400">
                        @error('status')
                ...
                <label class="block mb-4 text-sm">
                    ...
                    <input name="date_start" type="date" value="{{ $event->date_start }}"
                        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
                ...
                <label class="block mb-4 text-sm">
                    ...
                    <input name="date_end" type="date" value="{{ $event->date_end }}"
                        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
