<x-app-layout title="News">
    <div class="container grid px-6 mx-auto">
        <div class="mb-6">
            ...
            <a href="{{ route('dashboard.news.create') }}" class="inline bg-purple-600 px-3 py-2 rounded-md text-white no-underline">
                Create New News
            </a>
        </div>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4">
                                    ...
                                    {{-- Edit button --}}
                                    <a
                                        href="{{ route('dashboard.news.edit', $event->id) }}"
                                    ...
                                    {{-- Delete button --}}
                                    <form action="{{ route('dashboard.news.destroy', $event->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
