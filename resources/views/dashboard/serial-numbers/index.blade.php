                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4">
                                    {{-- Show Button --}}
                                    <a href="{{ route('dashboard.serial-numbers.show', $serialNumber->id) }}" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 bg-purple-600 text-white">
                                        Show
                                    </a>

                                    {{-- Edit button --}}
                                    <a
                                        href="{{ route('dashboard.serial-numbers.edit', $serialNumber->id) }}"
                                    ...
                                    {{-- Delete button --}}
                                    <form action="{{ route('dashboard.serial-numbers.destroy', $serialNumber->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
