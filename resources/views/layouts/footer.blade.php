        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <ul class="text-muted list-group list-group-flush">
                    <li class="text-muted">
                        <a href="{{route('events.index')}}">{{__('string.Events')}}</a>
                    </li>
                    <li class="text-muted">
                        <a href="{{route('news.index')}}">{{__('string.Articles')}}</a>
                    </li>
                    <li class="text-muted">
                        <a href="{{route('about-us')}}">{{__('string.About Us')}}</a>
                    </li>
                    <li class="text-muted">
                        <a href="{{route('contact-us')}}">{{__('string.Contact Us')}}</a>
                    </li>
                </ul>
            </div>
